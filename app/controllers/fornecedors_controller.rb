class FornecedorsController < ApplicationController
  ...
  def index
    @fornecedors = Fornecedor.paginate(:page => params[:page], :per_page => 15)
  end
  ...
  private
    ...
    def fornecedor_params
      params.require(:fornecedor).permit(:nome, :contato_funcao, :contato_nome, :cgc_cpf, :inscr_estadual, :endereco, :cidade, :estado, :cep, :telefone1, :telefone2, :telefone3, :email, :obs)
    end
end
