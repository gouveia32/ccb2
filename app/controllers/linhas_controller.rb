class LinhasController < ApplicationController
  ...
  # GET /linhas.json
  def index
    @linhas = Linha.paginate(:page => params[:page], :per_page => 15)
  end
  ...
  private
    ...
    def linha_params
      params.require(:linha).permit(:codigo, :nome, :material_nome, :material_fabricante, :material_tipo, :cor, :estoque_1, :estoque_2, :minimo, :pedido)
    end
end
